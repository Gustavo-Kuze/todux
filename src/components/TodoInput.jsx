            ...
            <div className="container mb-5" >
                <div className="row">
                    <div className="col-10">
                        <input value={this.state.todoInputValue} onChange={this.handleChange} className="form-control mb-3" type="text" placeholder="Digite uma tarefa e clique para adicionar" />
                    </div>
                    <div className="col-2">
